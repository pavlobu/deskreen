  ...
  return {
    ...
    async writeBundle() {
      ...
      try {
        ...
        console.log('Successfully copied client-viewer/dist to out/client-viewer');
      } catch (err) {
...
const copySimplePeerMinJsStaticFiles = () => {
  return {
    ...
    async writeBundle() {
      const sourceFile = resolve(__dirname, 'node_modules/simple-peer/simplepeer.min.js');
      ...
      try {
        ...
        console.log('Successfully copied simple-peer.min.js to out/client-viewer/static/js');
      } catch (err) {
