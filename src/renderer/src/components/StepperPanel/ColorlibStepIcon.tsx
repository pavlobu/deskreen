...
const useColorlibStepIconStyles = makeStyles({
  ...
  active: {
    backgroundImage: 'linear-gradient( 136deg, #FFB366 0%, #F29D49 50%, #A66321 100%)',
    boxShadow: '0 4px 10px 0 rgba(0,0,0,.25)',
  },
  completed: {
    backgroundImage: 'linear-gradient( 136deg, #3DCC91 0%, #15B371 50%, #0E5A8A 100%)',
  },
  stepContent: {},
});
...
export default function ColorlibStepIcon(props: StepIconPropsDeskreen): ReactNode {
  const { icon } = props;
