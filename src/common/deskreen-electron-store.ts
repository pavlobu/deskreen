...
export class PersistentStorage {
  ...
  /**
   * @param fileName The name of the file to save the data to. Defaults to 'storage.json'.
   */
  ...
  /**
   * Reads the data from the JSON file on disk.
   * @returns The parsed data object or an empty object if the file doesn't exist.
   */
  private readData(): DataStore {
    try {
